            ...
            <div class="w-1/2 flex flex-col justify-between items-center bg-slate-700 rounded-lg border border-slate-500 p-8 ml-2 min-h-[400px]">
                ...
                <form class="space-y-6 mt-6 w-3/4 max-w-sm">
                    <div class="mb-4">
                      ...
                      <input type="email" placeholder="Email" required value={email} onChange={(e) => setEmail(e.target.value)} class="w-full p-2 text-black bg-white-600 rounded focus:outline-none focus:ring-2 focus:ring-purple-400" />
                    </div>
                    <div class="mb-4">
                      <label class="block text-sm mb-1">Username</label>
                      <input type="username" placeholder="Username" required value={username} onChange={(e) => setUsername(e.target.value)} class="w-full p-2 text-black bg-white-600 rounded focus:outline-none focus:ring-2 focus:ring-purple-400" />
                    </div>
                    <div class="mb-4">
                      <label class="block text-sm mb-1">Password</label>
                      <input type="password" placeholder="Password" required value={password} onChange={(e) => setPassword(e.target.value)} class="w-full p-2 text-black bg-white-600 rounded focus:outline-none focus:ring-2 focus:ring-purple-400" />
                    </div>
                    <div class="mb-4">
